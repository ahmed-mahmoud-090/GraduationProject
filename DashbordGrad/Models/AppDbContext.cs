...
namespace Grad.Models
{
    public class AppDbContext:DbContext
    {
        ...
        public DbSet<DashbordGrad.Models.Bank>Banks { get; set; }
        public DbSet<EntertainmentPlace>EntertainmentPlaces { get; set; }
        public DbSet<DashbordGrad.Models.Hotel> Hotels { get; set; }
        public DbSet<Embasse>Embasses { get; set; }
        public DbSet<DashbordGrad.Models.Restaurant>Restaurants { get; set; }
